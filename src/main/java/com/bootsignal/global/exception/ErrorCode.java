...
/**
 * 애플리케이션 전역에서 사용하는 표준 에러 코드와 HTTP 상태를 정의합니다.
 */
public enum ErrorCode {
	...
	VERIFICATION_ALREADY_PROCESSED(HttpStatus.CONFLICT, "VERIFICATION_ALREADY_PROCESSED", "이미 처리된 인증 신청입니다."),
	VERIFICATION_EVIDENCE_REQUIRED(HttpStatus.BAD_REQUEST, "VERIFICATION_EVIDENCE_REQUIRED", "인증 증빙 파일은 필수입니다."),
	VERIFICATION_EVIDENCE_INVALID(HttpStatus.BAD_REQUEST, "VERIFICATION_EVIDENCE_INVALID", "인증 증빙 파일 정보가 올바르지 않습니다."),
	...
	PASSWORD_REUSE_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "PASSWORD_REUSE_NOT_ALLOWED", "기존 비밀번호와 동일한 비밀번호는 사용할 수 없습니다."),
	PASSWORD_NOT_AVAILABLE(HttpStatus.BAD_REQUEST, "PASSWORD_NOT_AVAILABLE", "비밀번호 로그인을 사용할 수 없는 계정입니다."),
	SOCIAL_LOGIN_REQUIRED(HttpStatus.BAD_REQUEST, "SOCIAL_LOGIN_REQUIRED", "소셜 로그인 계정입니다. 가입한 소셜 로그인으로 다시 로그인해 주세요."),
